...
`*` | user with many persons in the address book | delete multiple people at once | use less time instead of deleting people 1 by 1
`*` | user | sort persons by birthday | find out persons' birthdays for certain times
